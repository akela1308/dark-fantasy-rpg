...
// Позиции игрока: передний ряд r0, задний ряд r1 (смещение -168 по x)
// Позиции врагов: зеркало игрока вокруг x=640, задний ряд +168 по x
const UNIT_POSITIONS = {
  player: {
    0: { 0: { x: 549, y: 504 }, 1: { x: 587, y: 389 }, 2: { x: 612, y: 337 } }, // передний ряд
    1: { 0: { x: 381, y: 504 }, 1: { x: 419, y: 389 }, 2: { x: 444, y: 337 } }, // задний ряд (offset -168)
  },
  enemy: {
    0: { 0: { x: 731, y: 504 }, 1: { x: 693, y: 389 }, 2: { x: 668, y: 337 } }, // передний ряд (зеркало игрока)
    1: { 0: { x: 899, y: 504 }, 1: { x: 861, y: 389 }, 2: { x: 836, y: 337 } }, // задний ряд (offset +168)
  },
};
